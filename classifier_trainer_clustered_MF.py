...
trian_id = all_data[2]
train_seq = all_data[5]
train_go = all_data[8]
train_go_orig = all_data[11]
...
for fold in fold_range:
    ...
    trainer_filepath = "./model/clustered_top100MF_BCE.model"
    ...
    with open('./results/r_clustered_top100_MF.pkl', "wb") as output_file:
